...
{'id':1,
     ...
     'authors': ['Bowden et al..(2016)'],
     'references': ['Bowden, D. C., Kohler, M. D., Tsai, V. C., & Weeraratne, D. S. (2016). Offshore southern California lithospheric velocity structure from noise cross-correlation functions. Journal of Geophysical Research, 121(5), 3415-3427. doi: 10.1002/2016JB012919'],
...
{'id':2,
     ...
     'authors':['Doody et al.,(2023)','Doody (2023)'],
     'references':['Doody, C., Rodgers, A., Afanasiev, M., Boehm, C., Krischer, L., Chiang, A., & Simmons, N. (2023). CANVAS: An adjoint waveform tomography model of California and Nevada. Journal of Geophysical Research: Solid Earth, 128(12). https://doi.org/10.1029/2023JB027583','Doody, C. (2023). Dataset for "CANVAS: An adjoint waveform tomography model of California and Nevada" [Data set]. In Journal of Geophysical Research: Solid Earth (Vol. 128, Number 12). Zenodo. https://doi.org/10.5281/zenodo.8415562'],
...
{'id':8,
     ...
     'authors':['Ajala et al., (2019)'],
     'references':['Ajala, R., Persaud, P., Stock, J. M., Fuis, G. S., Hole, J. A., Goldman, M., & Scheirer, D. (2019). Three‐Dimensional Basin and Fault Structure From a Detailed Seismic Velocity Model of Coachella Valley, Southern California. Journal of Geophysical Research: Solid Earth,. doi: 10.1029/2018JB016260'],
...
{'id':9,
     ...
     'authors':['Shaw et al., (2004)'],
     'references':['Shaw, J. H., A. Plesch, C. Tape, M. P. Suess, T. H. Jordan, G. Ely, E. Hauksson, J. Tromp, T. Tanimoto, R. Graves, K. Olsen, C. Nicholson, P. J. Maechling, C. Rivero, P. Lovely, C. M. Brankman, J. Munster (2015). Unified Structural Representation of the southern California crust and upper mantle. Earth and Planetary Science Letters. 415 1, doi: 10.1016/j.epsl.2015.01.016 SCEC Contribution 2004'],
...
{'id':10,
     ...
     'description':'CVMH Inner Borderland Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':11,
     ...
     'description':'CVMH Los Angeles Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':12,
     ...
     'description':'CVMH Ridge Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
     ...
     'color':'#4B0082'},
{'id':13,
     'name':'CVM-H Santa Bernardino Basin',
     'abb name':'cvmhsbbn',
     'path name':'cvmhsbbn',
     'model filename':'cvmhsbbn.tar.gz',
     'description':'CVMH San Bernardino Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':14,
     ...
     'description':'CVMH Santa Barbara Channel Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':15,
     ...
     'description':'CVMH San Gabriel Valley Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':16,
     ...
     'description':'CVMH Santa Maria Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':17,
     ...
     'description':'CVMH Salton Trough Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':18,
     ...
     'description':'CVMH Ventura Basin Velocity Model',
     'authors':['Plesch et al., (2021)'],
     'references':['Plesch, A., C.H. Thurber, C. Tape, and J.H. Shaw (2021, 08), The SCEC CVM effort: new basin models, enhanced access and tomographic updates. Oral Presentation at 2021 SCEC Annual Meeting'],
...
{'id':19,
     ...
     'authors':['Magistrale et al., (2000)','Kohler et al., (2003)'],
     'references':['Magistrale, H, Day, S, Clayton, RW, Graves, RW (2000) The SCEC southern California reference three-dimensional seismic velocity model version 2. Bulletin of the Seismological Society of America 90(6B): S65–S76','Kohler, MD, Magistrale, H, Clayton, RW (2003) Mantle heterogeneities and the SCEC reference three-dimensional seismic velocity model version 3. Bulletin of the Seismological Society of America 93(2): 757–774'],
...
{'id':20,
     ...
     'authors':['Lee et al., (2014)'],
     'references':['Lee, E.-J., P. Chen, T. H. Jordan, P. J. Maechling, M. A. M. Denolle, and G. C.Beroza (2014), Full 3-D tomography for crustal structure in Southern California based on the scattering-integral and the adjoint-waveﬁeld methods, J. Geophys. Res. Solid Earth, 119, doi:10.1002/2014JB011346. SCEC Contribution 6093'],
...
{'id':22,
     ...
     'detail':'Depth:-5km to 16km',
     'authors':['Peraud et al., (2016)'],
     'references': ['Persaud P., Y. Ma, J. M. Stock, J. Hole, G. Fuis and L. Han (2016), Fault zone characteristics and basin complexity in the southern Salton Trough, California , Geology, 44(9), p. 747-750, doi:10.1130/G38033.1'],
...
{'id':27,
     ...
     'authors':['Magistrale et al., (2008)'],
     'references':['Magistrale, H, Olsen, KB, Pechmann, JC (2008) Construction and verification of a Wasatch front community velocity model. Technical report no. HQGR.060012, 14 pp. Reston, VA: US Geological Survey'],
...
"maps": [
    {'id':1,
     ...
     'authors':['Thompson (2022)'],
     'references':['Thompson, E.M. (2022), An Updated Vs30 Map for California with Geologic and Topographic Constraints (ver. 2.0, July 2022): U.S. Geological Survey data release, doi:10.5066/F7JQ108S'],
     'coordinates': [
        {'lon':-129.25,'lat':41},
...
"interpolator": [
    {'id': 1,
     ...
     'authors':['Ely et al., (2010)'],
     'references':['Ely, G., T. H. Jordan, P. Small, P. J. Maechling (2010), A Vs30-derived Near-surface Seismic Velocity Model Abstract S51A-1907, presented at 2010 Fall Meeting, AGU, San Francisco, Calif., 13-17 Dec.']
    },
    {'id': 2,
     'name': 'elygtl:taper',
