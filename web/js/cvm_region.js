...
{'id':21,
     ...
     'abb name':'mscal',
     'path name':'mscal',
     'model filename':'mscal.tar.gz',
     'description':'<br>&nbsp;&nbsp;&nbsp;The Multi-Scale CALifornia (MSCAL) statewide Vp and Vs velocity models provide high-quality integrated description of seismic structures across the state. Starting with the CANVAS base model (Doody et al., 2023), MSCAL incorporates multiple regional and local velocity datasets into a unified structure, capturing features ranging from broad crustal-mantle structures to fine-scale local anomalies such as sedimentary basins.<br>&nbsp;&nbsp;&nbsp;To ensure quality, the merged multi-scale models underwent a data-informed refinement process guided by simulations of small validation events. A key feature of MSCAL is the inclusion of a locally optimized near-surface low-velocity taper (LVT), specifically designed to better represent under-resolved shallow structures and improve the accuracy of ground-motion predictions.',
     'description_brief':'The Multi-Scale CALifornia (MSCAL) statewide Vp and Vs velocity models provide high-quality integrated description of seismic structures across the state. Starting with the CANVAS base model (Doody et al., 2023), MSCAL incorporates multiple regional and local velocity datasets ...',
...
{ 'type':'model','name':['sjfz'],
     ...
     'ref':'Fang, H., H. Yao, H. Zhang, C. Thurber, Y. Ben-Zion, and R. D. van der Hilst, 2019. Vp/Vs tomography in the southern California plate boundary region using body- and surface-wave traveltime data, Geophys. J. Int., 216, 609–620, doi: 10.1093/gji/ggy458',
},
...
{ 'type':'model','name':['uwpkfcvm'],
     ...
     'ref':'Zeng, Xiangfang, C. H. Thurber, D. R. Shelly, R. M. Harrington, E. S. Cochran, N. L. Bennington, D. Peterson, B. Guo and K. McClement, 3-D P- and S-wave velocity structure and low-frequency earthquake locations in the Parkfield, California region.  Geophys. J. Int. (2016) 206, 1574–1585. doi: 10.1093/gji/ggw217',
},
{ 'type':'model','name':['mscal'],
     'author':'...',
     'ref':'Zeng, Xiangfang, C. H. Thurber, D. R. Shelly, R. M. Harrington, E. S. Cochran, N. L. Bennington, D. Peterson, B. Guo and K. McClement, 3-D P- and S-wave velocity structure and low-frequency earthquake locations in the Parkfield, California region.  Geophys. J. Int. (2016) 206, 1574–1585. doi: 10.1093/gji/ggw217',
},
{ 'type':'map','name':['ucvm'],
