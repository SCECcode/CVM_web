...
{'id':1,
     ...
     'detail':'Southern California Off-shore Velocity Model<br>Depth:0 to 100km',
...
{'id':8,
     ...
     'detail':'Coachella Valley Velocity Model developed by LSU<br>Depth:-5km to 16km',
...
{'id':22,
     ...
     'detail':'Imperial Valley Velocity Model developed by LSU<br>Depth:-5km to 16km',
...
{'id':24,
     ...
     'detail':'USGS San Francisco Bay Region 3D Velocity Model<br>geology-based model with a non-uniform spacing',
...
"1D model": [
    {'id': 1,
     ...
     'detail':'Modified Hadley Kanamori 1D',
    },
    {'id': 2,
     'name':'Northridge Region 1D',
     'app name': 'bbp1d',
     'description': 'Los Angeles Region 1D model used in SCEC Broadband Platform',
    },
    {'id': 3,
